...
def calculate_similarity(embedding1, embedding2):
    try:
        ...
        raise Exception("Failed to calculate similarity.", str(e))
...
def extract_info(elm):
    try:
        ...
        raise Exception("Failed to extract info.", str(e))
...
def gen_desc_embeddings(results):
    try:
        ...
        print(traceback.format_exc())
        raise Exception("Failed to generate embeddings.", str(e))
...
def split_into_chunks(content):
    try:
        ...
        print(traceback.format_exc())
        raise Exception("Failed to split content into chunks.", str(e))
...
def navigate_and_extract(driver, url):
    try:
        ...
        raise Exception("Failed to navigate and extract content.", str(e))